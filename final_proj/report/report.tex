...
\begin{figure}[hbtp]
    \centering
    \subfloat[Initial position]{\includegraphics[width=.48\linewidth]{images/initial_position.png}}
    \subfloat[Final position]{\includegraphics[width=.48\linewidth]{images/final_position.png}}
