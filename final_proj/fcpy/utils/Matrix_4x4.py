...
class Matrix_4x4():
    ...
    def translate(self, translation_vec, in_place=False):
        '''
        Translates the current tranformation matrix
    ...
    def rotate_deg(self, rotation_vec, rotation_deg, in_place=False):
        '''
        Rotates the current tranformation matrix
    ...
    def rotate_x_rad(self, rotation_rad, in_place=False):
        '''
        Rotates the current tranformation matrix around the x-axis
    ...
    def rotate_y_rad(self, rotation_rad, in_place=False):
        '''
        Rotates the current tranformation matrix around the y-axis
    ...
    def rotate_z_rad(self, rotation_rad, in_place=False):
        '''
        Rotates the current tranformation matrix around the z-axis
    ...
    def invert(self, in_place=False):
        '''
        Inverts the current tranformation matrix
    ...
    def multiply(self,mat, in_place=False):
        '''
        Multiplies the current tranformation matrix by mat
