...
note: all behaviors are uniquely identified by their name
...
class Behavior():
    def __init__(self, world, scom) -> None:
        self.world = world
        self.scom = scom
        ...
        self.poses = Poses(world)
        self.slot_engine = Slot_Engine(world)
        self.head = Head(world)
    ...
    def get_custom_callbacks(self):
        ...
        from behaviors.custom.Walk_ZMP.Walk_ZMP import Walk_ZMP
        from behaviors.custom.Step.Step import Step
        from behaviors.custom.Get_Up.Get_Up import Get_Up
        from behaviors.custom.Walk_RL.Walk_RL import Walk_RL
        from behaviors.custom.Walk_RL3.Walk_RL3 import Walk_RL3
        from behaviors.custom.Kick_RL.Kick_RL import Kick_RL
        from behaviors.custom.Dribble_RL.Dribble_RL import Dribble_RL
        from behaviors.custom.Kick_Short_RL.Kick_Short_RL import Kick_Short_RL
        from behaviors.custom.Kick_Long_RL.Kick_Long_RL import Kick_Long_RL
        from behaviors.custom.Push_RL.Push_RL import Push_RL
        classes = [Walk_ZMP,Step,Get_Up,Walk_RL,Kick_RL,Walk_RL3,Dribble_RL,Kick_Short_RL,Kick_Long_RL,Push_RL]
