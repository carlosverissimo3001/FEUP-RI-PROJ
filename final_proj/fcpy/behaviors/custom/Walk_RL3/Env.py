...
class Env():
    ...
    def observe(self, init=False):
        ...
        self.obs[35:39] = r.joints_position[14:18] /100 # arms (front + side)
        ...
        internal_ori_diff =  np.clip( U.normalize_deg( self.walk_rel_orientation - self.internal_rel_orientation ), -MAX_ROTATION_DIFF, MAX_ROTATION_DIFF)
