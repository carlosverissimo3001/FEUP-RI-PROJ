...
class Radio():
    ...
    def check_broadcast_requirements(self):
        ...
        if sum(MIAs) > max_MIA: # checking if number of recently missing members is not above treshold
            return False
        ...
        #      - last update was >40ms ago
        #      - last update did not include the head (head is important to provide state and accurate position) OR:
