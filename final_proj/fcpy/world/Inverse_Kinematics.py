...
class Inverse_Kinematics():
    ...
    def leg(self, ankle_pos3d, foot_ori3d, is_left:bool, dynamic_pose:bool):
        ...
        *the yaw can be controlled directly, but the pitch and roll are biases (see below)
        ...
        knee = U.acos((sq_upper_leg_l + sq_lower_leg_l - sq_dist)/(2 * upper_leg_len * lower_leg_len)) + knee_extra_angle # Law of cosines
        foot = U.acos((sq_lower_leg_l + sq_dist - sq_upper_leg_l)/(2 * lower_leg_len * dist)) # foot perpendicular to vec(origin->ankle_pos)
