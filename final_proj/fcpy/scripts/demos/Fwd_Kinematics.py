...
class Fwd_Kinematics():
    ...
    def __init__(self,script:Script) -> None:
        ...
        self.show_body_parts_position_for    = 750 #steps
        self.show_joints_position_for        = 750 #steps
        self.show_body_parts_orientation_for = 1000 #steps
    ...
    def execute(self):
        ...
        #Beam players
        self.script.batch_commit_beam( [(-2,i*4-10,i*45) for i in range(5)] )

        #Draw position of body parts
        for i in range(self.show_body_parts_position_for):
        ...
        for i in range(self.show_joints_position_for):
            self.script.batch_execute_behavior("Squat")
            self.script.batch_commit_and_send()
            self.script.batch_receive()
        ...
        for i in range(self.show_body_parts_orientation_for):
            self.script.batch_execute_behavior("Squat")
            self.script.batch_commit_and_send()
            self.script.batch_receive()
