...
class Server():
    ...
    def __init__(self,script) -> None:
        ...
        self.options = ["Official Config", "Soccer Rules", "Sync Mode", "Real Time", "Cheats", "Full Vision", "Add Noise", "25Hz Monitor"]
        self.descriptions = ["Configuration used in official matches", "Play modes, automatic referee, etc.", 
        ...
        self.files = {"Soccer Rules" : self.source + "naosoccersim.rb",
                      "Sync Mode" : spark_f,
    ...
    def read_config(self):
        ...
        is_official_config = (v["Soccer Rules"] == "On" and v["Real Time"] == "On" and v["Cheats"] == "Off" and v["Full Vision"] == "Off" and
    ...
    def execute(self):
        ...
        while True:
            ...
            choice, is_str_opt = UI.read_particle('Choose setting ("r" to return): ',["r"],int,[0,len(self.options)])
            if is_str_opt: break # quit
            
            opt = self.options[choice]

            prefix = ['sudo', 'python3', 'scripts/tests/Server.py', opt]
