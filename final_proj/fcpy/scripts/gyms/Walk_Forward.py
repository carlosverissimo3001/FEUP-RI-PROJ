...
class Train(Train_Base):
    ...
    def train(self, args):
        ...
        learning_rate = 3e-4
        folder_name = f'Walk_Forward_R{self.robot_type}'
        ...
        def init_env(i_env):
            def thunk():
                return Walk_Forward( self.ip , self.server_p + i_env, self.monitor_p_1000 + i_env, self.robot_type, False )
            return thunk
    ...
    def test(self, args):
        ...
        env = Walk_Forward( self.ip, self.server_p-1, self.monitor_p, self.robot_type, True )
